...
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))  # for local imports

OUTPUT_PATH = "train/data/extractor_sft_data.jsonl"
...
COMPOUND_ANSWERS = [
    ...
    # Budget
    {
        "answer": "Budget is around 3000 euros for this phase.",
        "resolves": {
            "budget": "3000 euros",
        },
    },
    {
        "answer": "Budget is flexible, probably 5-10K for the full project.",
        "resolves": {
            "budget": "5-10K",
        },
    },
    ...
    # Full-scope answer
    {
        "answer": "WordPress site, modern design with dark theme, for our tech startup targeting developers.",
        "resolves": {

...
DATA_PATH = "training_data/extractor_sft_data.jsonl"
MODEL_NAME = "gpt2"
...
def main():
    ...
    if not os.path.exists(DATA_PATH):
        ...
        print("   python3 training_data/generate_extractor_sft.py")
        sys.exit(1)
    ...
    test_prompts = [
        (
            ...
            "timeline (Deadline or timeline) [EXTRACT]"
        ),
        (
        ...
        (
            ...
            "[UNDEFINED] budget range (Budget range for the project), timeline (Deadline), "
            "design style (Visual direction) [EXTRACT]"
        ),
    ]
